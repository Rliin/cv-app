...
function Testimonials() {
  return (
    <section id="testimonials" className="bg-[#111827] py-25 px-35 text-gray-400">
      ...
      <div className="flex flex-row gap-18 *:shadow-[0px_2px_6px_0px_rgba(0,_0,_0,_0.8)] **:[&>h3]:text-lg **:[&>h1]:text-white **:[&>h1]:text-2xl **:[&>h1]:font-bold **:[&>h1]:mb-1">
        <div className="flex flex-col text-xl items-center gap-10 bg-[#1F2937] mt-15 py-15 px-15 rounded-lg w-1/3">
        <CircleUserRound 
        size={64} 
        color="black"/>
