            ...
            >
              <div className="p-2 md:p-2 lg:p-5 hover:scale-101 transition-transform duration-400 ease-in-out">
                <Card className="bg-white dark:bg-[#1F2937]">
                  <CardContent className="flex  justify-center px-5 xs:px-10 ">
                      <a
                        className="flex justify-around flex-col items-center gap-10 rounded-lg"
                      ...
                      >
                        ...
                        >
                          ...
                          <h3 className="text-gray-400 text-base sm:text-xl lg:text-lg">{t(`testimonialTitle${index+1}`)}
                          </h3>
                        </div>
                      </a>
                  </CardContent>
