    ...
    return (
        <section id="introduction" className="flex justify-around gap-4 p-35 bg-[#030712] text-gray-400">
            ...
            <div className="relative *:rounded-lg w-[310px]">
                ...
                <Image src="/PhotoIntroduction.jpg" alt="Profile" className="rounded-lg" width={300} height={300} />
                </div>
            </div>
        </section>
    )
